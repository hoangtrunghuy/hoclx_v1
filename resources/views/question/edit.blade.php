<!-- <form action="{{ route('questions.update',$model->id) }}" method="post" >
    ...
    type		<input type="text" value="{{ $model->question_type }}" name="question_type">
    question	<input type="text" value="{{ $model->question_content }}" name="question_content">
    image		<img src="{{ $model->question_img }}" />
    			<input type="file" name="">
    answer		<input type="text" value="{{ $model->question_ansA }}" name="question_ansA">
    answer		<input type="text" value="{{ $model->question_ansB }}" name="question_ansB">
    answer		<input type="text" value="{{ $model->question_ansC }}" name="question_ansC">
    answer		<input type="text" value="{{ $model->question_ansD }}" name="question_ansD">
